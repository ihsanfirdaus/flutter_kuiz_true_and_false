...
import 'package:kuis/data/data_florafauna.dart';
import 'package:kuis/model/question_model.dart';
import 'package:kuis/views/result.dart';

class QuizFloraFauna extends StatefulWidget {
  @override
  _QuizFloraFaunaState createState() => _QuizFloraFaunaState();
}

class _QuizFloraFaunaState extends State<QuizFloraFauna> with SingleTickerProviderStateMixin{
